...
con.query("CREATE DATABASE IF NOT EXISTS appon1", function (err, result) {
if (err) throw err;
console.log("database created");
con.query("USE appon1", function (err, result) {
if (err) throw err;
var sql = "CREATE TABLE IF NOT EXISTS alia(id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(20), address VARCHAR(20));";
con.query(sql, function (err, result) {
if (err) throw err;
console.log("table created");
var sql = "INSERT INTO alia(id,name,address) VALUES (1,'ashwini','new delhi'),(2,'nandini','mysore'),(3,'teju','bangalore'),(4,'sana','mangalore')";
con.query(sql, function (err, result) {
if (err) throw err;
